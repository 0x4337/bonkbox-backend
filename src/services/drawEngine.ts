...
class DrawEngine {
  ...
  async executeDraw(): Promise<DrawResult> {
    // 1. Take snapshot
    const snapshot = await this.snapshotService.takeSnapshot("5bRfkgG2CfdDiCNNvjerqAaHNQNRa6Jw759diJYHmvzA", ["FhVo3mqL8PW5pH5U2CN4XE33DokiyZnUwuGpH2hmHLuM"]); // TODO: NEEDS CHANGING
